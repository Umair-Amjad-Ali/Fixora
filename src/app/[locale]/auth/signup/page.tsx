          ...
          <div className="w-full lg:w-7/12 flex items-center justify-center p-6 sm:p-10 md:p-12 bg-white dark:bg-[#030712]">
            <div className="w-full max-w-sm mx-auto">
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
              >
                <h2 className="text-2xl font-black mb-1">{t("createAccount")}</h2>
                <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest mb-8">{t("joinCommunity")}</p>
