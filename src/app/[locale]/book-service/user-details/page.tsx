...
import { User, Mail, Phone, ArrowRight, ShieldCheck, ArrowLeft } from "lucide-react";
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <input
                ...
                `}
              />
              {errors.name && <p className="text-red-500 text-[10px] font-bold mt-1 ml-1">{t("errorName")}</p>}
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative group">
              <input
                ...
                `}
              />
              {errors.email && <p className="text-red-500 text-[10px] font-bold mt-1 ml-1">{t("errorEmail")}</p>}
            </div>
          </div>
        </div>
          ...
          <div className="flex gap-2.5">
            <div className="relative w-24 shrink-0">
              <select
                ...
                className="w-full h-12 pl-3 pr-8 rtl:pr-3 rtl:pl-8 bg-zinc-50 dark:bg-slate-950 border border-zinc-200 dark:border-slate-800 rounded-xl outline-none appearance-none font-bold text-sm focus:border-primary transition-all cursor-pointer"
              >
                {COUNTRY_CODES.map((c) => (
              ...
              <div className="absolute right-3 rtl:right-auto rtl:left-3 top-1/2 -translate-y-1/2 pointer-events-none text-zinc-400">
            ...
            <div className="flex-1">
              <input
                ...
                `}
              />
              {errors.phone && <p className="text-red-500 text-[10px] font-bold mt-1 ml-1">{t("errorPhone")}</p>}
            </div>
          </div>
        </div>
