  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8 text-left">
        ...
        <p className="text-sm text-zinc-500 font-medium">Select the type of AC unit that needs attention.</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-primary/5 border border-primary/20 p-4.5 rounded-2xl flex items-center gap-4">
           ...
           <div>
              <p className="text-xs font-black text-foreground">Unit Selection Tip</p>
              <p className="text-[13px] font-medium text-zinc-500">Choosing the correct unit helps us send the right tools.</p>
           </div>
        </div>
