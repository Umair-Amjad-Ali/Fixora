  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8 text-left">
        ...
        <p className="text-sm text-zinc-500 font-medium">Select your preferred date and arrival time window.</p>
      </div>
      ...
      <div className="space-y-10">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <label className="text-xs font-black uppercase tracking-widest text-zinc-400">Select Date</label>
        ...
        <div className="space-y-5">
          <label className="text-xs font-black uppercase tracking-widest text-zinc-400 block">Select Arrival Window</label>
            ...
            {TIME_SLOTS.map((slot) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center p-4.5 rounded-2xl border transition-all duration-300 text-left overflow-hidden group
                    ${isSelected 
                  ...
                  `}
                >
                  <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-xl mr-4 transition-all
                  ...
                  <div className="flex-1">
                    <h4 className="font-black text-base leading-tight transition-colors">{slot.label}</h4>
                  ...
                  `}>
                    {isSelected && <ArrowRight size={12} strokeWidth={4} />}
                  </div>
                </button>
              );
            })}
