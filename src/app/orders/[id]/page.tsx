...
export default function OrderDetailPage() {
    ...
    return (
      <div className="min-h-screen pt-32 pb-20">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl text-center">
          ...
          <p className="text-zinc-500 mb-8 max-w-md mx-auto">This order doesn&apos;t exist or you don&apos;t have permission to view it.</p>
  ...
  const dateDesc = dateStr ? format(new Date(dateStr), "EEEE, MMMM dd, yyyy") : "To be determined";
  const createdDate = order.createdAt?.toDate ? format(order.createdAt.toDate(), "MMM dd, yyyy 'at' hh:mm a") : "N/A";
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-black text-lg">Service Details</h3>
                  <p className="text-xs text-zinc-400 font-medium">What was requested</p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    <h3 className="font-black">Schedule</h3>
                    <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-widest">When</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <InfoCell label="Date" value={dateDesc} />
                  <InfoCell label="Time" value={order.schedule?.timeRange || "Not specified"} />
                  {order.schedule?.urgency && <InfoCell label="Urgency" value={order.schedule.urgency.replace(/_/g, " ")} />}
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-widest">Where</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <InfoCell label="Address" value={order.location?.formattedAddress || "Not provided"} />
                  {order.location?.apartment && <InfoCell label="Unit / Villa" value={order.location.apartment} />}
                  {order.location?.instructions && <InfoCell label="Instructions" value={order.location.instructions} />}
                </div>
              </motion.div>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-widest">Your info</p>
                </div>
              </div>
              <div className="space-y-4">
            ...
            >
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-400 font-medium uppercase tracking-widest">Timeline</p>
                </div>
              </div>
              <div className="relative">
                {/* Vertical line */}
                <div className="absolute left-[15px] top-2 bottom-2 w-[2px] bg-zinc-100 dark:bg-slate-800" />
                <div className="space-y-6">
                  {timelineSteps.map((step, i) => {
                    ...
                    return (
                      <div key={step.key} className="flex items-start gap-4 relative">
                        ...
                        <div>
                          <p className={`text-sm font-black ${isReached ? "text-foreground" : "text-zinc-400"}`}>{step.label}</p>
                          <p className={`text-xs font-medium ${isReached ? "text-zinc-500" : "text-zinc-400/60"}`}>{step.desc}</p>
                        </div>
                      </div>
                    );
                  })}
