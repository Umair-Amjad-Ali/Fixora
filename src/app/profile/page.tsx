      ...
      <div className="pt-28 pb-20 bg-zinc-950 overflow-hidden relative border-b border-white/5">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl relative z-10">
          <Link href="/" className="flex items-center gap-2 text-zinc-400 hover:text-white transition-colors mb-6 w-fit group font-bold">
            ...
            <span className="text-[10px] uppercase tracking-widest">Return Home</span>
          </Link>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            >
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                  <InfoCell label="Full Name" value={userProfile?.name} icon={<User size={14} />} />
                  <InfoCell label="Email Address" value={user.email || ""} icon={<Mail size={14} />} />
                  <InfoCell label="Phone Number" value={userProfile?.phone} icon={<Phone size={14} />} />
                  <InfoCell label="Access Level" value="Standard Client" icon={<ShieldCheck size={14} />} />
               </div>
            </motion.div>
