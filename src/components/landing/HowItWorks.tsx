  ...
  return (
    ...
    >
      ...
      <div className="flex-1 w-full relative">
        ...
        >
          {/* Mockup Header */}
          <div className="flex items-center gap-2 mb-4 border-b border-zinc-100 dark:border-slate-800 pb-3 px-2">
          ...
          <div className="aspect-16/10 bg-zinc-50 dark:bg-slate-950 rounded-xl relative overflow-hidden flex items-center justify-center">
            {index === 0 && (
              <div className="w-full h-full p-6 flex flex-col gap-4">
                 ...
                 <div className="flex-1 border-2 border-dashed border-zinc-200 dark:border-slate-800 rounded-xl flex items-center justify-center">
                    <motion.div 
      ...
      <div className="flex-1 space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className={`h-px flex-1 bg-linear-to-r ${isEven ? 'from-transparent to-zinc-200 dark:to-slate-800' : 'from-zinc-200 dark:from-slate-800 to-transparent'}`} />
        </div>
        ...
        {index === 0 && (
          <div className="pt-4">
            <div className="bg-primary/5 border border-primary/10 rounded-2xl p-4 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-primary">GPS Integration</p>
                <p className="text-sm text-zinc-500 dark:text-zinc-400">Live technician tracking active</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-32">
          <div className="max-w-2xl">
            ...
            >
              Getting fixed <br/>
              <span className="text-zinc-400">has never been easier.</span>
            </motion.h2>
          </div>
          <motion.p 
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            className="hidden md:block text-zinc-500 text-xl max-w-xs font-medium border-l-4 border-primary pl-8 py-4"
          >
            We've combined technology with expertise to give you a seamless experience.
          </motion.p>
        </div>
        ...
        >
          ...
          <h4 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-6 relative z-10">Ready to experience the future <br className="hidden sm:block"/> of home maintenance?</h4>
